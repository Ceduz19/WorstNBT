...
class WorstNBTList extends AbstractList<NBT> implements NBTList {
    ...
    public @NotNull NBTList getList(int index) {
        return new WorstNBTList(this.handle.f(index));
    }

    @Override
    public short getShort(int index) {
        return this.handle.g(index);
    }

    @Override
    public int getInt(int index) {
        return this.handle.h(index);
    }

    @Override
    public int[] getIntArray(int index) {
        return this.handle.i(index);
    }
    ...
    public double getDouble(int index) {
        return this.handle.k(index);
    }

    @Override
    public float getFloat(int index) {
        return this.handle.l(index);
    }
    ...
    public boolean setNBT(int index, @NotNull NBT value) {
        this.handle.set(index, (NBTBase) value.getHandle());
        return true;
    }

...
class WorstNBTCompound implements NBTCompound {
    ...
    public @Nullable ItemStack createItemStack() {
        net.minecraft.server.v1_11_R1.ItemStack i = new net.minecraft.server.v1_11_R1.ItemStack(handle);
        return i.getItem() == null ? null : CraftItemStack.asCraftMirror(i);
    }

    @Override
    public boolean applyToEntity(@NotNull Entity entity) {
        net.minecraft.server.v1_11_R1.Entity nms = ((CraftEntity) entity).getHandle();
        try {
            nms.f(this.handle);
            return true;
        } catch (Exception e) {

package me.ceduz19.worstnbt.v1_20_R2;
...
class WorstNBTCompound implements NBTCompound {
    ...
    public boolean contains(@NotNull String key, @NotNull NBTType type) {
        return this.handle.contains(key, type.getId());
    }
    ...
    public org.bukkit.inventory.@Nullable ItemStack createItemStack() {
        ItemStack i = ItemStack.of(this.handle);
        return i == ItemStack.EMPTY ? null : i.asBukkitMirror();
    }
    ...
    public boolean applyToScoreboard(@NotNull Scoreboard scoreboard) {
        ...
        nms.dataFactory().deserializer().apply(this.handle);
        return true;
    }
